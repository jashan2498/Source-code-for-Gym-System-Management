...
<td width="20%"><% out.println(rs.getString("experience"));%></td>
<td width="20%"><% out.println(rs.getString("type"));%></td>
<td width="20%"><img src="${pageContext.request.contextPath}/fetch_trainers?<%out.print(ss);%>" width="250px" height="250px"></td> 
</tr>
<% } } 
catch(Exception ex)
{
